...
địa chỉ đó là rất phổ biến nên [thư viện chuẩn có một định nghĩa cho chúng mà chúng ta có thể sử dụng!][IpAddr]<!-- ignore --> Hãy xem cách thư viện chuẩn
...
Tuy nhiên, khái niệm mà null đang cố gắng biểu thị vẫn là một khái niệm hữu
...
rằng giá trị đang vắng mặt. Enum này là `Option<T>`, và nó được [định nghĩa bởi thư viện chuẩn][option]<!-- ignore --> như sau:
...
Nếu chúng ta chạy đoạn code này, chúng ta sẽ nhận được một thông báo lỗi như
sau:
...
thể kiểm tra chúng trong [tài liệu của nó][docs]<!-- ignore -->. Quen thuộc với
